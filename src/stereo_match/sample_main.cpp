...
int main(int argc, char **argv) {
    ...
    enum {
        STEREO_BM = 0, STEREO_SGBM = 1, STEREO_HH = 2, STEREO_VAR = 3, STEREO_3WAY = 4, STEREO_HH4 = 5
    };
    int alg = STEREO_SGBM;
...
//        fs["M2"] >> M2;
//        fs["D2"] >> D2;
    M1 = paramLoader.getInsML();
    D1 = paramLoader.getDL();
    M2 = paramLoader.getInsMR();
    D2 = paramLoader.getDR();
...
//        fs["R"] >> R;
//        fs["T"] >> T;
    R = paramLoader.getERrl();
    T = paramLoader.getETrl();
...
//    }
    ...
    Mat disp8_3c;
    if (color_display)
        cv::applyColorMap(disp8, disp8_3c, COLORMAP_AUTUMN);
